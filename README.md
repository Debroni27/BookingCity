# Бронирование отелей
Это репозиторий к Irlix ИПР в рамках разработки на Python с упором на изучение FastAPI и работы с SQLAlchemy, Celery, Redis, Docker, а также многими другими библиотеками и технологиями.
